...
nombre_archivo_salida = "jerarquia_fisicaprueba_red_total.png"
...
COLORES_POR_GRUPO = {
    "non-disciplinary": "#C2F4FC",   # azul
}

NODOS_POR_GRUPO = {
    "non-disciplinary": {"FIS.3.23", "FIS.4.18", "FIS.4.10", "FIS.3.11", "FIS.4.8"},
}

COLOR_RESTO_NODOS = "#F09886"
...
def main():
    ...
    plt.title(
         "Hierarchy of nodes in the physics network\n"
